...
function words_scripts() {
	wp_enqueue_style( 'words-vollkorn', 'http://fonts.googleapis.com/css?family=Vollkorn:400italic,400,700' );
	wp_enqueue_style( 'words-style', get_stylesheet_uri() );
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'words-scripts', get_template_directory_uri() . '/js/scripts.js', array(), false, true );
